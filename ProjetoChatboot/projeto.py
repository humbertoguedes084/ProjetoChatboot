...
def toddynho(mensagem):
    bot.send_message(mensagem.chat.id, "Otima escolha caixa com 10 por apenas 13.00")
...
def opcao3(mensagem):
    bot.send_message(mensagem.chat.id, "Para falar com entendente atravez do numero 84 3232-3232")
